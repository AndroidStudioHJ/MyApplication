...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            ...
            case R.id.btn_minus:
                ...
                if(selected_count <= 1) {
                    Toast.makeText(this, "최소주문은 1개입니다.", Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.btn_plus:
                selected_count = Integer.parseInt(edit_count.getText().toString());
                if(selected_count >= 5) {
                    Toast.makeText(this, "최대주문은 5개입니다.", Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.btn_pay:
                if(chk_agree.isChecked()) {
                    ...
                    intent.putExtra("MSG", "30318"); // 문자열
                    intent.putExtra("PRICE", val_pay); // 숫자: 총결제금액
                    startActivity(intent);
                }
                
                else {
                    Toast.makeText(this, "동의하세요!", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private void sumTotal() {
        ...
        // 화면에 표시
        txt_price.setText(Integer.toString(val_price) + "원");
        txt_price.setText(Integer.toString(val_delivery) + "원");
        txt_price.setText(Integer.toString(val_pay) + "원");
    }
}